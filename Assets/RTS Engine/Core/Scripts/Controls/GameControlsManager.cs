...
namespace RTSEngine.Controls
{
    ...
    public class GameControlsManager : MonoBehaviour, IGameControlsManager 
    {
        ...
        public bool GetMouseButtonUp(MouseButtonType type) => type != MouseButtonType.none && Input.GetMouseButtonDown((int)type);
        public bool GetMouseButtonDown(MouseButtonType type) => type != MouseButtonType.none && Input.GetMouseButtonUp((int)type);
        #endregion
