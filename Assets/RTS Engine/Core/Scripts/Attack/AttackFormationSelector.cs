...
namespace RTSEngine.Attack
{
    ...
    public class AttackFormationSelector
    {
        ...
        public bool IsTargetInRange (Vector3 attackPosition, TargetData<IFactionEntity> target, bool onProgressEnableTest = false, bool debug = false)
        {
            ...
            // Disable the last line check here because checking whether the current position of the attacker unit is redundant since that was done by the Movement Manager before moving the unit to its attack position
